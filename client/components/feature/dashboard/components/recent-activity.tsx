...
export function RecentActivity() {
  ...
  return (
    <Card className="glass border-neutral-800/50 hover:border-info-500/30 transition-all duration-300">
      ...
      <CardContent className="p-6 pt-0">
        <div className="space-y-4">
          {activities.map((activity) => (
            <div
              key={activity.id}
              className="flex items-start gap-4 p-4 rounded-lg bg-neutral-900/50 hover:bg-neutral-800/50 transition-all duration-300 border border-neutral-800/50 hover:border-neutral-700/50"
            >
